...
for xdag in 1 2; do
        if ls /home/pool/xdag${xdag}/client/xdag-tmp-* 1> /dev/null 2>&1; then
                FILES=`find /home/pool/xdag${xdag}/client -iname xdag-tmp-\* -mtime +1`
                if [[ $FILES != "" ]]; then
                        LATEST=`ls -t /home/pool/xdag${xdag}/client/xdag-tmp-* | head -n 1`
